...
fun main() {
    ...
    // loginAction2("", "", "", 88, "", "")
    loginAction2(usernam = "", uesername = "", username = "", userpwd = "", age = 99, phonenumber = "")
}
...
private fun loginAction2(username: String, userpwd: String, phonenumber: String, age: Int, usernam: String, uesername: String) {
    println("uername:$username, userpwd:$userpwd, phonenumber:$phonenumber, age:$age")
}